  ...
  return (
    <div className="space-y-2">
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg mb-1.5">
      ...
      <form onSubmit={handleSubmit} className="space-y-1.5">
        ...
        {error && (
          <div className="p-1.5 rounded-lg bg-red-50 border border-red-100 text-red-700 text-xs">
            {error}
          </div>
        )}
